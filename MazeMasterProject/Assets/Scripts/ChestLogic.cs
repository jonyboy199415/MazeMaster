...
public class ChestLogic : MonoBehaviour {
    ...
    IEnumerator DoAnimation()
    {
        ...
        for (int i = 0; i < randomNumber; i++)
        {
            ...
            Instantiate(coinPrefab, transform.position+ new Vector3(-1,0,0), transform.rotation);
        ...
        if (randomNumber < 3)
        {
			Instantiate(ingot, transform.position+ new Vector3(-1,0,0), transform.rotation);
        }
    }  
  }
